        ...
        <div className="p-6 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              <FieldRow label="Case Service Type" value="Omni_Line Reconnection(OmniContact Helpdesk Support)" />
              <div className="flex gap-3 text-sm">
                ...
                <div className="flex-1 min-h-24 px-4 py-3 border border-slate-200 rounded-lg text-sm text-slate-800 dark:border-slate-600 dark:text-slate-200">
                  Kindly assist customer 263123467896 by reconnecting their line
                </div>
              </div>
            </div>
          </section>
